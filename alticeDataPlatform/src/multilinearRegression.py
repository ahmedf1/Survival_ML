...
#newCustomerdf = pd.read_csv('/Users/Farhad_Ahmed/Desktop/Altice/Cleaned Data for NewCustomers - Sheet1.csv', header=None,delim_whitespace=False,skiprows=1,delimiter=',', names=col_names,na_values='?')
